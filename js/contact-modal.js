...
document.addEventListener('DOMContentLoaded', function () {
    ...
    confirmButton.addEventListener('click', function (e) {
      ...
      // --- 入力値をモーダルに反映 ---
      const mapping = {
        'confirm-radio-kinds': 'radio-kinds',
        'confirm-your-name': 'your-name',
        'confirm-your-furigana': 'your-furigana',
        'confirm-your-email': 'your-email',
        'confirm-tel-number01': 'tel-number01',
        'confirm-tel-number02': 'tel-number02',
        'confirm-tel-number03': 'tel-number03',
        'confirm-post-code01': 'post-code01',
        'confirm-post-code02': 'post-code02',
        'confirm-your-address': 'your-address',
        'confirm-your-school': 'your-school',
        'confirm-your-grade': 'your-grade',
        'confirm-date-time': 'date-time',

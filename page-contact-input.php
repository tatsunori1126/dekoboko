                ...
                <div id="confirmation-modal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="p-contact__confirm-contents-container">
                            ...
                            <div class="p-contact__confirm-contents-wrapper"><h3 class="p-contact__confirm-contents-title">■ふりがな</h3><span class="p-contact__confirm-item" id="confirm-your-furigana"></span></div>

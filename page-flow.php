                                ...
                                <div class="p-flow__content">
                                    ...
                                    <div class="p-flow__text-wrapper">
                                        <p class="p-flow__text">
                                            DEKObokoで学びたい！と思っていただけましたら、ご入塾・ご入会のお手続きを進めます。必要書類のご案内や費用・スケジュールの確認を行い、初回授業の日程やご受講の日時を決定いたします。<br>
                                            ・小学生コースは<a href="<?php echo esc_url( home_url( '/shougakusei' ) ); ?>">こちら</a><br>
                                            ・中高生コースは<a href="<?php echo esc_url( home_url( '/chuukousei' ) ); ?>">こちら</a><br>
                                            ・保護者コースは<a href="<?php echo esc_url( home_url( '/kyoiku-hogosha' ) ); ?>">こちら</a><br>
                                            ・よくあるご質問は<a href="<?php echo esc_url( home_url( '/faq' ) ); ?>">こちら</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
